        ...
        <motion.div ref={ref} initial={{ opacity: 0, y: 40 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }}>
          ...
          <div className="about-grid">
            <div className="about-text">
              ...
              <p className="about-body">I help organizations navigate the complexities of cybersecurity compliance by translating technical frameworks into tangible business outcomes. Currently consulting at Risk Crew, I guide clients through the full Cyber Essentials and CE+ journey to move beyond a simple "tick-box" mentality and deliver rigorous technical verification alongside actionable gap analysis. My academic foundation includes an MSc in Cybersecurity Analytics from the University of Exeter, which is backed by extensive, hands-on experience in end-to-end compliance. Previously, I spent two years as a freelance consultant building robust security strategies for small businesses with a specific focus on endpoint management and security hardening. Because I recognize that most breaches exploit human behavior rather than just technical flaws, I take a holistic approach to security and prioritize team education and awareness just as highly as system auditing.</p>
